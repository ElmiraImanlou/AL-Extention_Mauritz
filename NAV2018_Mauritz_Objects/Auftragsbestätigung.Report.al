Report 50001 "Auftragsbestätigung"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Auftragsbestätigung.rdlc';
        ...
        dataitem(OuterCopyLoop; "Integer")
        {
            ...
            dataitem(Header; "Sales Header")
            {
                ...
                var
                    ...
                    i: Integer;
                    MauritzDiscountManagement: Codeunit "Mauritz Discount Management";
                    SalesLine: Record "Sales Line";
                    InvDiscAmount: Decimal;
                    InvDiscPct: Decimal;
                    VATAmt: Decimal;
                begin
                    MauritzDiscountManagement.CalcSalesDocumentTotals(Header, SalesLine, InvDiscAmount, InvDiscPct, VATAmt, true);
    ...
    var
        ThisReport: Report "Auftragsbestätigung";
