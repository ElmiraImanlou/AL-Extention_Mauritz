Report 50007 "MAURITZ Reminder"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/MAURITZ Reminder.rdlc';
    Caption = 'Reminder';
    ...
    dataset
    {
        dataitem(OuterCopyLoop; "Integer")
        {
            ...
            dataitem(Header; "Issued Reminder Header")
            {
                ...
                column(Header_OrderNo; '')
                {
                }
                column(Header_PricesIncludingVAT; false)
                {
                }
                ...
                dataitem(InnerCopyLoop; "Integer")
                {
                    ...
                    dataitem(Lines; "Issued Reminder Line")
                    {
                        DataItemLink = "Reminder No." = field("No.");
                        DataItemLinkReference = Header;
                        DataItemTableView = sorting("Reminder No.", "Line No.") order(ascending);
                        ...
                        column(Lines_Description; Lines.Description)
                        {
                        }
                        ...
                        column(Lines_NoofReminders; Lines."No. of Reminders")
                        {
                        }
                        column(Lines_PostingDate; Lines."Posting Date")
                        {
                        }
                        column(Lines_DocumentDate; Lines."Document Date")
                        {
                        }
                        column(Lines_DueDate; Lines."Due Date")
                        {
                        }
                        column(Lines_DocumentType; Lines."Document Type")
                        {
                        }
                        column(Lines_DocumentNo; Lines."Document No.")
                        {
                        }
                        column(Lines_OriginalAmount; Lines."Original Amount")
                        {
                        }
                        column(Lines_RemainingAmount; Lines."Remaining Amount")
                        {
                        }
                        column(LineType; Format(LineType, 0, '<Number>'))
                        {
                        }
                        ...
                        begin
                            case true of
                                Lines."Line No." < FirstPositionLineNo:
                                    LineType := Linetype::TextBefore;
                                Lines."Line No." > LastPositionLineNo:
                                    LineType := Linetype::TextAfter;
                                else
                ...
                var
                    ...
                    ReminderLine: Record "Issued Reminder Line";
                begin
                    ...
                    ReminderLine.SetRange(Type, ReminderLine.Type::"G/L Account", ReminderLine.Type::"Customer Ledger Entry");
                    if ReminderLine.FindFirst then
                        FirstPositionLineNo := ReminderLine."Line No.";

                    if ReminderLine.FindLast then
                        LastPositionLineNo := ReminderLine."Line No.";
    ...
    var
        ...
        FirstPositionLineNo: Integer;
        LastPositionLineNo: Integer;
        LineType: Option TextBefore,Position,TextAfter;
        CopyPrint: Boolean;
    ...
    begin
        ...
        case RecRef.Number of
            ...
            297:
                case Type of
                    0:
                        FormatAddress.IssuedReminder(AddressArray, Header);
                end;
        end;
    ...
    var
        ThisReport: Report "MAURITZ Reminder";
