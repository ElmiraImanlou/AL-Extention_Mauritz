Report 50002 Bestellung
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Bestellung.rdlc';
        ...
        dataitem(OuterCopyLoop; "Integer")
        {
            ...
            dataitem(Header; "Purchase Header")
            {
                ...
                dataitem(InnerCopyLoop; "Integer")
                {
                    ...
                    dataitem(Lines; "Purchase Line")
                    {
                        DataItemLink = "Document Type" = field("Document Type"), "Document No." = field("No.");
                        DataItemLinkReference = Header;
                        DataItemTableView = sorting("Document Type", "Document No.", "Line No.") order(ascending) where("Attached to Line No." = const(0));
                        ...
                        column(Lines_UnitPrice; Lines."Direct Unit Cost")
                        {
                        }
